...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-math company-auctex lsp-python lsp-typescript lsp-javascript-typescript js2-mode lsp-php lsp-css lsp-html spaceline which-key neotree flycheck yasnippet company-lsp lsp-ui lsp-mode flx counsel-projectile projectile counsel ivy doom-themes use-package auctex))))
